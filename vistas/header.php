...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>AGENDA</b> DIGITAL</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="../vistas/usuario.php" class="btn btn-default btn-flat">Perfil</a>
                </div>
...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
        ...
        <li><a href="https://keen-squirrel-b2a417.netlify.app/" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Empresa</span><small class="label pull-right bg-yellow">Engineering Innovation</small></a></li>   
